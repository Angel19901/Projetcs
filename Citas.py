...
class firstwindow():
    def __init__(self,user):
        ...
        title_frame.place(x=610, y=50, width=210, height=100)
        ...
        # ------TABLA DE CITAS------
        tree = ttk.Treeview(tableau_frame, height=10, columns=("one", "two"))
        tree.grid(padx=5, pady=5, row=0, column=0, columnspan=1)
        tree.heading("#0", text='Nombre')
        tree.heading("one", text='Fecha')
        tree.heading("two", text='Hora')
