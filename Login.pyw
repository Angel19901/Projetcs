...
def insesion():
    ...
    if (cajaTexto1.get()=="" or cajaTexto2.get()==""):
        ...
        if(prueba.ValidUser(name, password, "root") == True or prueba.ValidUser(name, password, "admin") == True or prueba.ValidUser(name, password, "assistant")== True):
